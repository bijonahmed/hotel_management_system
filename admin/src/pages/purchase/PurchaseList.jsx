...
const PurchaseList = () => {
  ...
  const apiUrl = "/purchase/getInvoiceList";
  ...
  const handleAddNewClick = () => {
    navigate("/purchase/create-invoice");
  };

  const handleEdit = (id) => {
     navigate(`/purchase/edit-invoice?invoice_id=${id}`);
  };

  const handlePrint = (id) => {
      navigate(`/purchase/print-invoice?invoice_id=${id}`);
  };
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Purchase List</div>
                <div className="ps-3">
                      ...
                      <div className="row align-items-center mb-3">
                        <div className="col-12 col-md-5 mb-2 mb-md-0">
                          <div className="searchbar">
                            <input
                              type="text"
                              placeholder="Search Invoice No, Phone, Name, Email"
                              ...
                              {data.length > 0 ? (
                                data.map((item) => (
                                  <tr key={item.id}>
                                    ...
                                    <td>{item.name}</td>
                                    <td className="text-end"> {item.phone}</td>

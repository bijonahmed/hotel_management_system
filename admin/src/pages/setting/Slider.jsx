...
const Slider = () => {
  ...
  const getSlidermages = async () => {
    try {
      const response = await axios.get(`/setting/getsSliderImages`, {
        headers: {
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        const response = await axios.get(`/setting/delteSliderImages`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
          params: { id: id },
  ...
  const handleSubmit = async (formData) => {
    try {
      ...
      formPayload.append("title_name", formData.title_name);
      formPayload.append("status", 1);

      // ✅ Append Image File
      if (formData.sliderImage) {
        formPayload.append("sliderImage", formData.sliderImage);
      }

      const response = await axios.post(
        "/setting/sliderImagesSave",
        formPayload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Slider List</div>
                <div className="ps-3">
              ...
              <div className="card radius-10">
                <div className="card-body">
                  <div className="container-fluid">
                    <div className="row">
                      {sliderImage.map((rimages, index) => (
                        <div className="col-3 mb-3" key={index}>
                          <div className="card">
                            <img
                              src={rimages.sliderImage} // Ensure this is a valid image URL
                              alt="Room"

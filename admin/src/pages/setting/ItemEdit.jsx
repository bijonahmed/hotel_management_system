...
const ItemEdit = () => {
  ...
  const defaultFetch = async () => {
    try {
      const response = await axios.get(`/setting/checkItemRow`, {
        headers: {
      ...
      setUnitPrice(userData.unit_price || "");
      setNotes(userData.notes || "");
      setName(userData.name || "");
      setStatus(
        userData.status === 1 || userData.status === 0 ? userData.status : ""
      );
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("/setting/itemSave", formData, {
        headers: {
          Authorization: `Bearer ${token}`,
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Edit Item</div>
                <div className="ps-3">
